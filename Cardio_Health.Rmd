...
```{r}
# No Interaction Model
no_int_summary <- summary(best_LR_no_int)
no_int_odds <- exp(coef(best_LR_no_int))
no_int_odds_ci <- exp(confint(best_LR_no_int))
no_int_pvalues <- no_int_summary$coefficients[,4]
no_int_matrix <- data.frame(no_int_odds, no_int_odds_ci, no_int_pvalues)
no_int_matrix <- no_int_matrix %>% rename(odds_ratio = no_int_odds, X2.5 =  X2.5.., X97.5 = X97.5.., pvalues = no_int_pvalues)
no_int_matrix
```
